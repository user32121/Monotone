...
public class InteractionMask {
        ...
        public static int addSchematic(CommandContext<FabricClientCommandSource> ctx) {
                ...
                try {
                        ...
                        ctx.getSource().sendFeedback(
                                        Text.literal(String.format("Unable to create schematic mask: %s", e)));
                        return -1;
                }
        ...
        public static int list(CommandContext<FabricClientCommandSource> ctx) {
                ...
                ctx.getSource().sendFeedback(
                                Text.literal(String.format("%s mask is %s with regions:", interaction,
                                                b ? "enabled" : "disabled")));
        ...
        public static int remove(CommandContext<FabricClientCommandSource> ctx) {
                ...
                if (index >= regions.size()) {
                        ctx.getSource()
                                        .sendFeedback(Text.literal(String.format("%s mask has no region at index %s",
                                                        interaction, index)));
                        return -1;
                }
        ...
        public static int clear(CommandContext<FabricClientCommandSource> ctx) {
                ...
                regions.clear();
                ctx.getSource().sendFeedback(
                                Text.literal(String.format("Cleared %s regions from %s mask", size, interaction)));
                return size;
        }
        ...
        public static int enable(CommandContext<FabricClientCommandSource> ctx) {
                ...
                ctx.getSource()
                                .sendFeedback(Text.literal(String.format("Enabled %s mask (%s regions)", interaction,
                                                regions.size())));
                return 1;
        }
        ...
        public static int disable(CommandContext<FabricClientCommandSource> ctx) {
                ...
                ctx.getSource().sendFeedback(
                                Text.literal(String.format("Disabled %s mask (%s regions)", interaction,
                                                regions.size())));
                return 1;
        }
        ...
        public static int setDisplay(CommandContext<FabricClientCommandSource> ctx) {
                ...
                ctx.getSource().sendFeedback(Text.literal(
                                String.format("Set %s mask display to %s (%s regions)", interaction, display,
                                                regions.size())));
                return 1;
        }
        ...
        public static int getDisplay(CommandContext<FabricClientCommandSource> ctx) {
                ...
                ctx.getSource().sendFeedback(
                                Text.literal(String.format("Displaying %s mask is %s", interaction, display)));
                return 1;
        }
}
